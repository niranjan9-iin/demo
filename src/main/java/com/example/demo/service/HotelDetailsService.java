...
public class HotelDetailsService {
	...
	// public static ArrayList<String> fieldsets = new
	// ArrayList<>(Arrays.asList("profile"));

	public String getHotelDetails(String hotelCode, String brandCode) {
		ResponseComparator.result = "";
